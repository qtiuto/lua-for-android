...
public class JDKPlatformProvider implements PlatformProvider {
    ...
    static {
        ...
        SUPPORTED_JAVA_PLATFORM_VERSIONS.add("9");
    ...
    static class PlatformDescriptionImpl implements PlatformDescription {
        ...
        //private final Map<File, FileSystem> ctSym2FileSystem = new HashMap<>();
        ...
        @Override
        public Collection<File> getPlatformPath() {
            ...
            if (file.exists()) {
                ...
                if (fs == null) {
                    try {
                        ctSym2FileSystem.put(file, fs = FileSystems.newFileSystem(file.toURI(), null));
