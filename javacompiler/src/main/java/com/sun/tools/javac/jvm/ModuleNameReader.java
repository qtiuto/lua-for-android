...
import com.sun.tools.javac.file.FileUtils;
...
public class ModuleNameReader {
    ...
    public String readModuleName(File p) throws IOException, BadClassFile {
        try (InputStream in = FileUtils.newInputStream(p)) {
