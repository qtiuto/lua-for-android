...
public class AnnotationType {
    ...
    static ConcurrentHashMap<Class,AnnotationType> types=new ConcurrentHashMap<>();
    ...
    {
        AnnotationType result = types.get(annotationClass); // volatile read
        if (result == null) {
            result = new AnnotationType(annotationClass);
            // try to CAS the AnnotationType: null -> result
            types.put(annotationClass,result);
        }
