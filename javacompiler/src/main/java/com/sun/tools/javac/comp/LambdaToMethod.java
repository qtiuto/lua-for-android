...
import static com.sun.tools.javac.comp.LambdaToMethod.LambdaSymbolKind.CAPTURED_OUTER_THIS;
...
public class LambdaToMethod extends TreeTranslator {
     ...
     */
    class LambdaAnalyzerPreprocessor extends com.sun.tools.javac.tree.TreeTranslator {
                ...
                for (LambdaSymbolKind kind : LambdaSymbolKind.values()) {
                    ...
                    switch(kind) {
                        default:
                            ...
                            break;
                        case CAPTURED_OUTER_THIS:
                            Optional<Symbol> proxy = StreamSupport.stream(m.keySet())
