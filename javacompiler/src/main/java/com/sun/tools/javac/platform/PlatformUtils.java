...
public class PlatformUtils {
    ...
    public static PlatformDescription lookupPlatformDescription(String platformString) {
        ...
        return StreamSupport.stream(Iterables.spliterator(providers), false)
                            .filter(provider -> StreamSupport.stream(Iterables.spliterator(provider.getSupportedPlatformNames())
                                                                            ,
                                                                     false)
