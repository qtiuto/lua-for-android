...
public class Symtab {
    ...
    public ClassSymbol getClass(ModuleSymbol msym, Name flatName) {
        ...
        return Maps.getOrDefault(classes,flatName, Collections.emptyMap()).get(msym);
    }
    ...
    public void removeClass(ModuleSymbol msym, Name flatName) {
        Maps.getOrDefault(classes,flatName, EMPTY).remove(msym);
    }
    ...
    private void doEnterClass(ModuleSymbol msym, ClassSymbol cs) {
        Maps.computeIfAbsent(classes,cs.flatname, n -> new HashMap<>()).put(msym, cs);
    }
    ...
    private void doEnterPackage(ModuleSymbol msym, PackageSymbol pack) {
        Maps.computeIfAbsent(packages,pack.fullname, n -> new HashMap<>()).put(msym, pack);
    ...
    public PackageSymbol getPackage(ModuleSymbol module, Name fullname) {
        return Maps.getOrDefault(packages,fullname, Collections.emptyMap()).get(module);
    }
    ...
    public Iterable<ClassSymbol> getClassesForName(Name candidate) {
        return Maps.getOrDefault(classes,candidate, Collections.emptyMap()).values();
    }

    public Iterable<PackageSymbol> getPackagesForName(Name candidate) {
        return Maps.getOrDefault(packages,candidate, Collections.emptyMap()).values();
    }
}
