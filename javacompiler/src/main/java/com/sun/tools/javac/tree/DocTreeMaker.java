...
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.H1;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.H2;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.H3;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.H4;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.H5;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.H6;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.P;
import static com.sun.tools.javac.tree.DocTreeMaker.HtmlTag.PRE;
...
public class DocTreeMaker implements DocTreeFactory {
    ...
    private static HtmlTag get(CharSequence name){
        return HtmlTag.valueOf(name.toString().toUpperCase());
    }
