...
public class LanguageLua extends Language {
    ...
    private final static String package_java = "type|newArray|proxy|instanceof|import|object|charString|charValue|new|lock|unlock|put|remove|try|throw";
    ...
    private final static String extFunctionTarget = "Type|newArray|proxy|instanceof|import|object|charString|charValue|new|lock|unlock|put|remove|try|throw";
