...
public class LanguageLua extends Language {
    ...
    private final static String package_java = "type|newArray|proxy|instanceof|typeof|super|import|object|charString|charValue|new|sync|try|throw|using";
    ...
    private final static String extFunctionTarget = "class|newArray|proxy|instanceof|super|typeof|import|object|charString|charValue|new|sync|try|throw|cross|using";
